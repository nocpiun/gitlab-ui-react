...
<DocsExample filename="form-select/FormSelectGroupsExample.tsx" title="Grouped select options"/>

## Accessibility

- Associate the select with a visible `<label>` using matching `htmlFor` and `id` values.
...
### GlFormSelectItem and GlFormSelectGroup

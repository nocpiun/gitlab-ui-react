...
<DocsExample filename="icon/IconExample.tsx" title="Icon with text"/>
...
<DocsExample filename="icon/IconSizesExample.tsx" title="Icon sizes"/>
...
<DocsExample filename="icon/IconVariantsExample.tsx" title="Semantic icon variants"/>

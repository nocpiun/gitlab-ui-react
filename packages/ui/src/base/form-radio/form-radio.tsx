 ...
 * - Group integration (upstream's `getRadioGroup` injection) is deferred
 *   until GlFormRadioGroup is ported; standalone behavior is complete.
...
const GlFormRadio = forwardRef<HTMLInputElement, GlFormRadioProps>(function GlFormRadio({
  ...
  const isChecked = looseEqual(localChecked, value);
